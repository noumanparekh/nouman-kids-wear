...
const categories = [
  {
    ...
    description: 'Traditional ethnic wear for boys - perfect for festivals and special occasions',
    accent: 'sky',
    displayOrder: 1,
    active: true,
    slug: {
  ...
  },
  {
    ...
    description: 'Beautiful ethnic wear collection for girls',
    accent: 'peach',
    displayOrder: 3,
    active: true,
    slug: {
  ...
  {
    _id: 'category-girls-lehenga-choli',
    _type: 'category',
    title: 'Girls Lehenga Choli',
    description: 'Stunning lehenga choli sets for traditional events',
    accent: 'mint',
    displayOrder: 4,
    active: true,
    slug: {
      _type: 'slug',
      current: 'girls-lehenga-choli',
    },
  },
]
...
const products = [
  ...
  // Girls Lehenga Choli
  {
    ...
    category: { _type: 'reference', _ref: 'category-girls-lehenga-choli' },
    gender: 'girls',
    ageGroup: 'kids',
